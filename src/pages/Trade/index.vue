<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix">
<!--        <span class="username " @click="changePayway(1)" :class="{selected:pay ===1}">在线支付{{pay}}</span>-->
<!--        <span class="username" style="margin-left:5px;" @click="changePayway(2)" :class="{selected:pay ===2}">货到付款</span>-->
             <span class="username" v-for="(a,index) in 2" :key="index" @click="changePayway(a)" :class="{selected:pay ===a}">支付方式{{a}}</span>
