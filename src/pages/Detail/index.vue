...
export default {
  ...
  computed: {
    ...
    skuSale() {
      // return this.spuSaleAttrList.forEach((item) => {
      //   item.spuSaleAttrValueList.forEach((item, index, array) => {
      //     if (item.isChecked === 0) {
  ...
  methods: {
    ...
    foreh(){
      ...
      this.spuSaleAttrList.forEach((item)=>{
        console.log(item.spuSaleAttrValueList,111)
        let a= item.spuSaleAttrValueList.filter((item)=>{return item.isChecked ==='1'})
        //  item.spuSaleAttrList.filter((item)=>{
        //   console.log(item)
      ...
      // for(let i =0;i in this.spuSaleAttrList;i++){
      //
      //   // console.log(this.spuSaleAttrList[i])
      //   let a = this.spuSaleAttrList[i].spuSaleAttrValueList.filter((item)=>{
      //     console.log(item)
      //     return item.isChecked==='1'
      //
      //
